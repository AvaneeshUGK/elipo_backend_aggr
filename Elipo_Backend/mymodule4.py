...
def postPaperAiResponse(event=None, context=None):
    ...
    # pdfTextExtractionJobId = '1690884129859'
        ...
        try:
            with mydb.cursor() as mycursor:
                ...
                sqlQuery = "INSERT INTO invoice_header (in_status, sup_status, from_supplier, user_invoice_id, ref_po_num, " \
                           ...
                           " business_area, supplier_id, supplier_name, cost_center, is_igst, tds_per, payment_terms, npo, document_type, gstin,tax_per) " \
                           "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?)"
                ...
                values = (header["status"], sup_status, from_supplier, header["user_invoice_no"], header["ref_po_num"],
                          ...
                          header['tds'],
                          header["payment_terms"], npo, header['doc_type'], header['gstin'],header["tax_per"])
